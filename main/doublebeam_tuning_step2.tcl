...
puts "Tuning with beamstrahlung - STEP 2 - Incoherent pairs Random Walk"
...
# load machines after step 1
#############################################################################
load_beamline_status "electron" $res_dir/Results_step1/machine_status_electron_$machine.dat
load_beamline_status "positron" $res_dir/Results_step1/machine_status_positron_$machine.dat
...
#############################################################################
set iter [random_walk_pairs $subset]
puts "iter = $iter"
