...
#
# Step 3: incoherent pairs fast tuning knobs
#
...
puts "Tuning with beamstrahlung - STEP 3 - Tuning with fast knobs"
...
# load machines after step 2
#############################################################################
load_beamline_status "electron" $res_dir/Results_step2/machine_status_electron_$machine.dat
load_beamline_status "positron" $res_dir/Results_step2/machine_status_positron_$machine.dat
