...
#
# Step 5: incoherent pairs tuning knobs, 1e5 macropartiles
#
...
set save_dir $res_dir/Results_step5
...
puts "Tuning with beamstrahlung - STEP 5 - Fine tuning with knobs"
...
# load machines after step 4
#############################################################################
load_beamline_status "electron" $res_dir/Results_step4/machine_status_electron_$machine.dat
load_beamline_status "positron" $res_dir/Results_step4/machine_status_positron_$machine.dat
...
#############################################################################
sextupole_knobs_1e5 5.0 $machine
